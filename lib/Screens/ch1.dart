...
class _ch1State extends State<ch1>{
  ...
  void initState() {
    ...
    super.initState();
    firestoreInstance.collection("Language").doc("Chapter1").snapshots().listen((event) {
      ...
      body: SingleChildScrollView(child: Column(
        children: [
          ...
          StreamBuilder<Object>(
            stream: firestoreInstance.collection("Language").doc("Chapter1").snapshots(),
