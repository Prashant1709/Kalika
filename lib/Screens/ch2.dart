...
class ch2 extends StatefulWidget {
  const ch2({Key? key}) : super(key: key);
...
class _ch2State extends State<ch2> {
  ...
  void initState() {
    ...
    super.initState();
    firestoreInstance.collection("Language").doc("Chapter2").snapshots().listen((event) {
      ...
      body: SingleChildScrollView(child: Column(
        children: [
          ...
          StreamBuilder<Object>(
              stream: firestoreInstance.collection("Language").doc("Chapter2").snapshots(),
